...
const db = new sqlite3.Database('db.sqlite', (err) => {
    if (err) {
        ...
        db.run(`CREATE TABLE parkings(id INTEGER PRIMARY KEY AUTOINCREMENT,title TEXT NOT NULL,description TEXT NOT NULL,lots INTEGER NOT NULL, remaining_lots INTEGER NOT NULL,location TEXT UNIQUE NOT NULL)`,
